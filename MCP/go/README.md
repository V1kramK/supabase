# Supabase Storage API MCP Server

This MCP (Model Content Protocol) server provides access to Supabase Storage API API functionality through HTTP, HTTPS, and STDIO transport modes.
