...
func Get_render_image_sign_bucketname_wildcardHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		*, ok := *Val.(string)
		...
		url := fmt.Sprintf("%s/render/image/sign/%s/%s%s", cfg.BaseURL, bucketName, *, queryString)
...
func CreateGet_render_image_sign_bucketname_wildcardTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_render_image_sign_bucketName_wildcard",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_render_image_sign_bucketname_wildcardHandler(cfg),
	}
}
