...
func Post_iceberg_v1_prefix_namespacesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/iceberg/v1/%s/namespaces", cfg.BaseURL, prefix)
...
func CreatePost_iceberg_v1_prefix_namespacesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_iceberg_v1_prefix_namespaces",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_iceberg_v1_prefix_namespacesHandler(cfg),
	}
}
