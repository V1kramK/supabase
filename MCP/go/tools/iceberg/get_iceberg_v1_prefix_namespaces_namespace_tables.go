...
func Get_iceberg_v1_prefix_namespaces_namespace_tablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/iceberg/v1/%s/namespaces/%s/tables%s", cfg.BaseURL, prefix, namespace, queryString)
...
func CreateGet_iceberg_v1_prefix_namespaces_namespace_tablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_iceberg_v1_prefix_namespaces_namespace_tables",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_iceberg_v1_prefix_namespaces_namespace_tablesHandler(cfg),
	}
}
