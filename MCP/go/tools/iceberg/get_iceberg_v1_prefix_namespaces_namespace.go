...
func Get_iceberg_v1_prefix_namespaces_namespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_iceberg_v1_prefix_namespaces_namespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_iceberg_v1_prefix_namespaces_namespace",
		mcp.WithDescription("Load a namespace"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_iceberg_v1_prefix_namespaces_namespaceHandler(cfg),
	}
}
