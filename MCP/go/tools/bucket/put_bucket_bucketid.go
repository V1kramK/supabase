...
func Put_bucket_bucketidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/bucket/%s", cfg.BaseURL)
...
func CreatePut_bucket_bucketidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_bucket_bucketId",
		mcp.WithDescription("Update properties of a bucket"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_bucket_bucketidHandler(cfg),
	}
}
