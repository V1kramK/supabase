...
func Get_object_bucketname_wildcardHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_object_bucketname_wildcardTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_object_bucketName_wildcard",
		mcp.WithDescription("Get object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_object_bucketname_wildcardHandler(cfg),
	}
}
