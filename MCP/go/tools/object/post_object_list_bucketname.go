...
func Post_object_list_bucketnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/object/list/%s", cfg.BaseURL, bucketName)
...
func CreatePost_object_list_bucketnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_object_list_bucketName",
		...
		mcp.WithObject("sortBy", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_object_list_bucketnameHandler(cfg),
	}
}
