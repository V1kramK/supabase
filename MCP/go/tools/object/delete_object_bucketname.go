...
func Delete_object_bucketnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/object/%s", cfg.BaseURL, bucketName)
...
func CreateDelete_object_bucketnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_object_bucketName",
		mcp.WithDescription("Delete multiple objects"),
		mcp.WithString("bucketName", mcp.Required(), mcp.Description("")),
		mcp.WithString("authorization", mcp.Required(), mcp.Description("")),
		mcp.WithArray("prefixes", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Delete_object_bucketnameHandler(cfg),
	}
}
