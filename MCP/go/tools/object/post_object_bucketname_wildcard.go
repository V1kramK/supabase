...
func Post_object_bucketname_wildcardHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_object_bucketname_wildcardTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_object_bucketName_wildcard",
		mcp.WithDescription("Upload a new object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_object_bucketname_wildcardHandler(cfg),
	}
}
