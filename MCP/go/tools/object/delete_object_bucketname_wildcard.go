...
func Delete_object_bucketname_wildcardHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_object_bucketname_wildcardTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_object_bucketName_wildcard",
		mcp.WithDescription("Delete an object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_object_bucketname_wildcardHandler(cfg),
	}
}
